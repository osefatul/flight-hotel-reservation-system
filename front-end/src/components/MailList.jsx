  ...
  return (
    <div className="w-full bg-slate-900 text-white flex flex-col items-center space-y-2 p-5 mt-10">
      ...
      <div className="mailInputContainer">
        <input type="text" placeholder="Enter your email" className='bg-slate-900 !outline-none border border-yellow-500 rounded-sm p-1 mr-2 h-6 sm:h-8 w-38 sm:w-56 placeholder:text-[12px]  '/>
